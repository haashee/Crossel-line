    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12 text-center">
                <h3 class="mt-5 text-white">Webhookの確認</h3>
                <h5 class="text-white font-weight-normal pb-4">Page to connect new LINE account.</h5>
                <div class="multisteps-form mb-5">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 m-auto">
                            <form action="{{ route('accounts.checked',['aid' => $account->id]) }}" method="POST" enctype="multipart/form-data"
